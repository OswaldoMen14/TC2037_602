...
We did our best effort to implement every accept state for the DFA. Nevertheless, we had a lot of problems
and it did not work. We thought it was for Sunday and we had a long week, this is why we could not obtain the
expected results :(
|#
